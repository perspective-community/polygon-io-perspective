...
/***/ "./node_modules/@finos/perspective/dist/pkg/esm/perspective.cpp.js":
/*!*************************************************************************!*\
  !*** ./node_modules/@finos/perspective/dist/pkg/esm/perspective.cpp.js ***!
  \*************************************************************************/
...
var load_perspective = (() => {
  ...
  return function (load_perspective) {
    ...
    var wasmBinaryFile;
    wasmBinaryFile = "perspective.cpp.wasm";
...
/***/ "./node_modules/@finos/perspective/src/js/api/server.js":
/*!**************************************************************!*\
  !*** ./node_modules/@finos/perspective/src/js/api/server.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config */ "./node_modules/@finos/perspective/src/js/config/index.js");
/******************************************************************************
 *
...
/***/ "./node_modules/@finos/perspective/src/js/config/constants.js":
/*!********************************************************************!*\
  !*** ./node_modules/@finos/perspective/src/js/config/constants.js ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@finos/perspective/src/js/data_accessor/index.js":
/*!***********************************************************************!*\
  !*** ./node_modules/@finos/perspective/src/js/data_accessor/index.js ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils.js */ "./node_modules/@finos/perspective/src/js/utils.js");
/* harmony import */ var _config_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../config/index.js */ "./node_modules/@finos/perspective/src/js/config/index.js");
/******************************************************************************
 *
...
/***/ "./node_modules/@finos/perspective/src/js/emscripten.js":
/*!**************************************************************!*\
  !*** ./node_modules/@finos/perspective/src/js/emscripten.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@finos/perspective/src/js/perspective.js":
/*!***************************************************************!*\
  !*** ./node_modules/@finos/perspective/src/js/perspective.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _config_constants_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config/constants.js */ "./node_modules/@finos/perspective/src/js/config/constants.js");
/* harmony import */ var _config_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./config/index.js */ "./node_modules/@finos/perspective/src/js/config/index.js");
/* harmony import */ var _data_accessor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./data_accessor */ "./node_modules/@finos/perspective/src/js/data_accessor/index.js");
/* harmony import */ var _emscripten_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./emscripten.js */ "./node_modules/@finos/perspective/src/js/emscripten.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils.js */ "./node_modules/@finos/perspective/src/js/utils.js");
/* harmony import */ var _api_server_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./api/server.js */ "./node_modules/@finos/perspective/src/js/api/server.js");
/* harmony import */ var _view_formatters__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view_formatters */ "./node_modules/@finos/perspective/src/js/view_formatters.js");
/******************************************************************************
 *
 * Copyright (c) 2017, the Perspective Authors.
 *
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(Module) {
  ...
  view.prototype.expression_schema = function () {
    let override = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
  ...
  view.prototype.to_csv = function (options) {
    ...
    if (this.is_unit_context) {
      return __MODULE__.to_csv_unit(this._View, start_row, end_row, start_col, end_col);
    } else if (sides === 0) {
      return __MODULE__.to_csv_zero(this._View, start_row, end_row, start_col, end_col);
    } else if (sides === 1) {
      return __MODULE__.to_csv_one(this._View, start_row, end_row, start_col, end_col);
    } else if (sides === 2) {
      return __MODULE__.to_csv_two(this._View, start_row, end_row, start_col, end_col);
    }
  };
  /**
  ...
  view.prototype.col_to_js_typed_array = function (col_name) {
  ...
  table.prototype.validate_expressions = function (expressions) {
...
/***/ "./node_modules/@finos/perspective/src/js/view_formatters.js":
/*!*******************************************************************!*\
  !*** ./node_modules/@finos/perspective/src/js/view_formatters.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
 ...
 *
 */
const DEFAULT_CONFIG = (__webpack_require__(/*! ./settings.js */ "./node_modules/@finos/perspective/src/js/config/settings.js")["default"]);
...
"use strict";
/*!***************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js!./node_modules/@finos/perspective/src/js/perspective.worker.js ***!
  \***************************************************************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
